...
StartTest(t => {
    ...
    t.it('Should switch to month view upon click of a year\'s month name header', async t => {
        ...
        t.selectorCountIs('.b-cal-event-icon:visible', 2, 'Icons rendered for non allDay events and the event with an icon');
        t.selectorCountIs('.b-cal-recurrence-icon:visible', 3, 'No recurrence icons are visible');
    });
    ...
    t.it('eventColor should work', async t => {
        ...
        t.hasStyle(bars[2], 'background-color', 'rgb(255, 0, 0)');
        t.hasStyle(bars[2], 'color', 'rgb(96, 96, 96)');
        ...
        t.hasStyle(bars[4], 'background-color', 'rgba(0, 0, 0, 0)');
        t.hasStyle(bars[4], 'color', 'rgb(96, 96, 96)');

        // Icons are all as configured
        t.hasStyle(icons[1], 'color', 'rgb(255, 0, 0)');
        t.hasStyle(icons[2], 'color', 'rgb(0, 0, 255)');
        t.hasStyle(icons[3], 'color', 'rgb(255, 0, 0)');

        t.hasStyle(icons[0], 'color', 'rgb(0, 0, 255)');
        t.hasStyle(icons[4], 'color', 'rgb(255, 0, 0)');
    });

    // https://github.com/bryntum/support/issues/7256
    t.it('auto row height should render out all events for the day', async t => {
        calendar = await t.getCalendar({
            events : [
                {
                    id             : 5,
                    name           : 'Scrum',
                    startDate      : '2020-10-12T13:00:00',
                    duration       : 1,
                    durationUnit   : 'hour',
                    recurrenceRule : 'FREQ=WEEKLY;BYDAY=TU,TH',
                    resourceId     : 'bryntum',
                    important      : true,
                    notes          : 'Plan work for next week.'
                },
                {
                    id         : 10,
                    startDate  : '2020-08-11T14:00:00',
                    endDate    : '2020-10-21T12:00:00',
                    name       : 'Super busy week',
                    allDay     : true,
                    resourceId : 'bryntum',
                    important  : false,
                    notes      : 'Get everything done'
                },
                {
                    id         : 20,
                    startDate  : '2020-08-11T18:00:00',
                    endDate    : '2020-10-11T20:00:00',
                    name       : 'Beer time',
                    allDay     : true,
                    resourceId : 'michael',
                    important  : true,
                    notes      : 'Relax after all the hard work'
                },

                {
                    id         : 30,
                    startDate  : '2020-08-11T09:00:00',
                    endDate    : '2020-10-11T12:00:00',
                ...
                {
                    id         : 40,
                    startDate  : '2020-08-11T10:00:00',
                    endDate    : '2020-10-11T13:00:00',
                    name       : 'Dinner',
                    resourceId : 'bryntum',
                    important  : false,
                ...
                {
                    id         : 43,
                    startDate  : '2020-08-11T14:30:00',
                    endDate    : '2020-10-11T17:00:00',
                    name       : 'More stuff',
                    resourceId : 'bryntum',
                    important  : true,
                ...
                },
                {
                    id         : 47,
                    startDate  : '2020-08-11T18:00:00',
                    endDate    : '2020-10-11T19:00:00',
                    name       : 'Baz',
                    resourceId : 'michael',
                    important  : false,
                    notes      : 'Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem'
                },

                {
                    id         : 50,
                    startDate  : '2020-08-12T09:00:00',
                ...
                {
                    id         : 60,
                    startDate  : '2020-08-12T09:30:00',
                    endDate    : '2020-10-12T12:00:00',
                    name       : 'Get at it',
                    resourceId : 'bryntum',
                    important  : true,
                    notes      : 'Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur'
                },
                {
                    id         : 70,
                    startDate  : '2020-08-12T10:20:00',
                    endDate    : '2020-10-12T13:30:00',
                    name       : 'Break out',
                    resourceId : 'michael',
                    important  : false,
                    notes      : 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga'
                },
                {
                    id         : 62,
                    startDate  : '2020-08-12T11:30:00',
                    endDate    : '2020-10-12T13:00:00',
                    name       : 'Moving forward',
                    resourceId : 'bryntum',
                    important  : true,
                ...
                {
                    id         : 80,
                    startDate  : '2020-08-12T14:00:00',
                    endDate    : '2020-10-12T18:00:00',
                    name       : 'Back at it',
                    resourceId : 'hotel',
                    important  : true,
                ...
                {
                    id         : 90,
                    startDate  : '2020-08-12T15:00:00',
                    endDate    : '2020-10-12T16:30:00',
                    name       : 'Red pill',
                    resourceId : 'michael',
                    important  : false,
                ...
                {
                    id         : 100,
                    startDate  : '2020-08-12T15:30:00',
                    endDate    : '2020-10-12T18:00:00',
                    name       : 'Swarm',
                    resourceId : 'hotel',
                    important  : false,
                    notes      : 'Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat'
                },
                {
                    id         : 105,
                    startDate  : '2020-08-12T17:00:00',
                ...
                {
                    id         : 2110,
                    startDate  : '2020-08-13T09:00:00',
                    endDate    : '2020-10-13T14:00:00',
                    name       : 'Rock on',
                    resourceId : 'hotel',
                    important  : true,
                    notes      : 'Vivamus vel dui magna. Pellentesque porta, dui dictum sagittis lobortis, sapien nunc auctor elit, vitae volutpat leo eros ac lacus. In odio erat, volutpat quis dui vel, sollicitudin vulputate quam'
                },
                {
                    id         : 2120,
                    startDate  : '2020-08-13T10:00:00',
                    endDate    : '2020-10-13T12:30:00',
                    name       : 'Bust a move',
                    resourceId : 'bryntum',
                    important  : true,
                    notes      : 'Duis malesuada viverra tristique. Vivamus tempor quis ligula sit amet interdum'
                },
                {
                    id         : 2130,
                    startDate  : '2020-09-13T10:30:00',
                    endDate    : '2020-10-13T11:30:00',
                    name       : 'Pow wow',
                    resourceId : 'michael',
                    important  : true,
                    notes      : 'Duis dignissim bibendum ipsum non imperdiet. Curabitur fringilla, mi at maximus congue, nibh diam lacinia nunc, eu congue lorem magna eget arcu'
                },
                {
                    id         : 2140,
                    startDate  : '2020-09-13T11:15:00',
                    endDate    : '2020-10-13T13:00:00',
                    name       : 'Hip hop',
                    resourceId : 'bryntum',
                    important  : false,
                    notes      : 'Aenean consectetur volutpat lacus id tempus. Interdum et malesuada fames ac ante ipsum primis in faucibus'
                },
                {
                    id         : 2144,
                    startDate  : '2020-09-13T12:45:00',
                    endDate    : '2020-10-13T14:30:00',
                    name       : 'Roll out',
                    resourceId : 'michael',
                    important  : true,
                    notes      : 'Sed lacinia, ante eu tincidunt fermentum, ex tellus euismod diam, nec molestie dui mi eget nibh'
                },

                {
                    id         : 2150,
                    startDate  : '2020-09-13T15:00:00',
                    endDate    : '2020-10-13T19:30:00',
                    name       : 'Rock it',
                    resourceId : 'hotel',
                    important  : false,
                    notes      : 'Nulla molestie turpis et enim congue, in posuere nisl placerat. Nam cursus ultricies mauris sit amet molestie. Integer quis congue nisl'
                },
                {
                    id         : 2152,
                    startDate  : '2020-09-13T15:45:00',
                    endDate    : '2020-10-13T18:00:00',
                    name       : 'Comet',
                    resourceId : 'bryntum',
                    important  : true,
                    notes      : 'Aliquam eu tortor ante'
                },
                {
                    id         : 2154,
                    startDate  : '2020-08-13T16:30:00',
                    endDate    : '2020-10-13T17:30:00',
                    name       : 'Blast off',
                    resourceId : 'michael',
                    important  : false,
                    notes      : 'Duis porttitor nisl vel turpis viverra, ut interdum urna molestie'
                },
                {
                    id         : 2156,
                    startDate  : '2020-10-13T17:00:00',
                    endDate    : '2020-10-13T19:00:00',
                    name       : 'Ship out',
                    resourceId : 'bryntum',
                    important  : true,
                    notes      : 'Nunc et porta enim, non mollis sem'
                },
                {
                    id         : 2158,
                    startDate  : '2020-10-13T18:15:00',
                    endDate    : '2020-10-13T20:30:00',
                    name       : 'Pop out',
                    resourceId : 'michael',
                    important  : true,
                    notes      : 'Nam vel ultricies purus. Curabitur iaculis lobortis dui interdum ultricies. Vestibulum a ullamcorper est'
                },

                {
                    id         : 3110,
                    startDate  : '2020-10-14T09:00:00',
                    endDate    : '2020-10-14T12:00:00',
                    name       : 'Rock on',
                    resourceId : 'hotel',
                    important  : true,
                    notes      : 'Pellentesque commodo mauris metus, id suscipit nisi rhoncus sit amet'
                },
                {
                    id         : 3120,
                    startDate  : '2020-10-14T10:00:00',
                    endDate    : '2020-10-14T12:30:00',
                    name       : 'Bust a move',
                    resourceId : 'bryntum',
                    important  : true,
                    notes      : 'Nam quis leo augue. Quisque lacinia neque ex, eget egestas lorem aliquet id'
                },
                {
                    id         : 3130,
                    startDate  : '2020-10-14T10:30:00',
                    endDate    : '2020-10-14T11:30:00',
                    name       : 'Pow wow',
                    resourceId : 'michael',
                    important  : true,
                    notes      : 'Etiam pharetra ex vitae imperdiet euismod'
                },
                {
                    id         : 3140,
                    startDate  : '2020-10-14T11:15:00',
                    endDate    : '2020-10-14T13:00:00',
                    name       : 'Hip hop',
                    resourceId : 'bryntum',
                    important  : false,
                    notes      : 'Nullam auctor porta urna, id consectetur nibh consectetur in'
                },
                {
                    id         : 3144,
                    startDate  : '2020-10-14T12:30:00',
                    endDate    : '2020-10-14T14:30:00',
                    name       : 'Roll out',
                    resourceId : 'michael',
                    important  : true,
                    notes      : 'In hac habitasse platea dictumst. Aliquam in nibh erat'
                },
                {
                    id         : 3150,
                    startDate  : '2020-10-14T15:00:00',
                    endDate    : '2020-10-14T18:15:00',
                    name       : 'Rock it',
                    resourceId : 'hotel',
                    important  : false,
                    notes      : 'Pellentesque finibus aliquam vehicula'
                },
                {
                    id         : 3152,
                    startDate  : '2020-10-14T15:45:00',
                    endDate    : '2020-10-14T18:00:00',
                    name       : 'Comet',
                    resourceId : 'bryntum',
                    important  : false,
                    notes      : 'Pellentesque laoreet, nisl non efficitur accumsan, est urna convallis neque, ac eleifend est felis ut neque. Aliquam erat volutpat'
                },
                {
                    id         : 3154,
                    startDate  : '2020-10-14T16:30:00',
                    endDate    : '2020-10-14T17:30:00',
                    name       : 'Blast off',
                    resourceId : 'michael',
                    important  : true,
                    notes      : 'Aliquam porttitor tincidunt lorem, quis scelerisque ipsum tincidunt nec'
                },
                {
                    id         : 3156,
                    startDate  : '2020-10-14T17:00:00',
                    endDate    : '2020-10-14T19:00:00',
                    name       : 'Ship out',
                    resourceId : 'bryntum',
                    important  : true,
                    notes      : 'Maecenas dictum non orci ut interdum'
                },
                {
                    id         : 3158,
                    startDate  : '2020-10-14T18:15:00',
                    endDate    : '2020-10-14T20:30:00',
                    name       : 'Pop out',
                    resourceId : 'michael',
                    important  : false,
                    notes      : 'Phasellus convallis nec diam sit amet cursus'
                },

                {
                    id         : 4160,
                    startDate  : '2020-10-15T09:00:00',
                    endDate    : '2020-10-15T13:00:00',
                    name       : 'Kick off',
                    resourceId : 'hotel',
                    important  : false,
                    notes      : 'Aliquam non turpis id justo efficitur pharetra nec vitae nulla'
                },
                {
                    id         : 4162,
                    startDate  : '2020-10-15T10:00:00',
                    endDate    : '2020-10-15T13:30:00',
                    name       : 'Excursion',
                    resourceId : 'bryntum',
                    important  : true,
                    notes      : 'Quisque bibendum ex eu dui lobortis malesuada'
                },
                {
                    id         : 4164,
                    ...
                    resourceId : 'michael',
                    important  : true,
                    notes      : 'Morbi tempus accumsan orci, at faucibus sem facilisis at'
                },
                {
                    id        : 4170,
                    ...
                    name      : 'Summit',
                    important : false,
                    notes     : 'Etiam congue risus eros, scelerisque luctus ante malesuada a'
                },
                {
                    id         : 4180,
                    startDate  : '2020-10-15T15:00:00',
                    endDate    : '2020-10-15T18:00:00',
                    name       : 'Add up',
                    resourceId : 'bryntum',
                    important  : true,
                    notes      : 'Praesent sapien ex, ultrices ac consequat quis, vehicula dictum lectus'
                },
                {
                    id         : 4182,
                    startDate  : '2020-10-15T15:30:00',
                    endDate    : '2020-10-15T19:00:00',
                    name       : 'Dinner',
                    resourceId : 'hotel',
                    important  : false,
                    notes      : 'Suspendisse urna quam, auctor vitae suscipit sed, viverra sed velit'
                },
                {
                    id         : 4184,
                    startDate  : '2020-10-15T16:00:00',
                    endDate    : '2020-10-15T19:30:00',
                    name       : 'Dinner',
                    resourceId : 'bryntum',
                    important  : false,
                    notes      : 'Aenean vitae leo massa. Duis aliquam tristique metus nec posuere'
                },
                {
                    id         : 4190,
                    startDate  : '2020-10-15T16:30:00',
                    endDate    : '2020-10-15T18:00:00',
                    name       : 'Dinner',
                    resourceId : 'michael',
                    important  : true,
                    notes      : 'Mauris vel velit egestas, tempus metus sed, sagittis orci'
                },

                {
                    id         : 5200,
                    startDate  : '2020-10-16T09:00:00',
                    endDate    : '2020-10-16T13:30:00',
                    name       : 'Dasher',
                    resourceId : 'hotel',
                    important  : true,
                    notes      : 'Nullam interdum suscipit ante imperdiet gravida'
                },
                {
                    id         : 5210,
                    startDate  : '2020-10-16T10:00:00',
                    endDate    : '2020-10-16T11:30:00',
                    name       : 'Dancer',
                    resourceId : 'bryntum',
                    important  : false,
                    notes      : 'Morbi malesuada a justo vel dictum'
                },
                {
                    id         : 5220,
                    startDate  : '2020-10-16T11:00:00',
                    endDate    : '2020-10-16T12:30:00',
                    name       : 'Prancer',
                    resourceId : 'michael',
                    important  : true,
                    notes      : 'Donec risus magna, tincidunt ac leo vel, rutrum scelerisque turpis. Integer tristique nec arcu non vehicula'
                },
                {
                    id         : 5230,
                    startDate  : '2020-10-16T12:00:00',
                    endDate    : '2020-10-16T14:00:00',
                    name       : 'Vixen',
                    resourceId : 'bryntum',
                    important  : true,
                    notes      : 'Phasellus ac lobortis orci. Ut faucibus cursus nunc, eget sollicitudin eros suscipit vel'
                },
                {
                    id         : 5240,
                    startDate  : '2020-10-16T12:00:00',
                    endDate    : '2020-10-16T14:30:00',
                    name       : 'Cupid',
                    resourceId : 'etc',
                    important  : false,
                    notes      : 'Nam mollis ex sodales, lacinia ante at, scelerisque sem. Phasellus tempor sit amet mauris quis consectetur'
                },
                {
                    id         : 5250,
                    startDate  : '2020-10-16T15:00:00',
                    endDate    : '2020-10-16T19:30:00',
                    name       : 'Lightning',
                    resourceId : 'hotel',
                    important  : true,
                    notes      : 'Donec justo mi, pharetra et euismod congue, rutrum vitae magna'
                },
                {
                    id         : 5260,
                    startDate  : '2020-10-16T16:00:00',
                    endDate    : '2020-10-16T17:30:00',
                    name       : 'Thunder',
                    resourceId : 'bryntum',
                    important  : true,
                    notes      : 'Aliquam dignissim sem ex, sed ornare eros condimentum quis'
                },
                {
                    id         : 5270,
                    startDate  : '2020-10-16T17:00:00',
                    endDate    : '2020-10-16T18:30:00',
                    name       : 'Flood',
                    resourceId : 'michael',
                    important  : true,
                    notes      : ' Sed sodales consectetur libero, in vehicula nisi venenatis et. Donec a sollicitudin velit'
                },
                {
                    id         : 5280,
                    ...
                    resourceId : 'bryntum',
                    important  : false,
                    notes      : 'Aliquam id arcu nec nisl mattis sagittis'
                },
                {
                    id         : 5290,
                    startDate  : '2020-10-16T18:45:00',
                    endDate    : '2020-10-16T20:30:00',
                    name       : 'Hurricane',
                    resourceId : 'etc',
                    important  : false,
                    notes      : 'Etiam finibus tellus sit amet massa interdum posuere'
                },
                {
                    id         : 5300,
                    startDate  : '2020-10-16T18:45:00',
                    ...
                    resourceId : 'hotel',
                    important  : true,
                    notes      : 'Integer sit amet consequat massa. Mauris volutpat tristique justo laoreet fringilla. Vivamus nec auctor diam. Sed sit amet neque diam'
                }
            ],
            resources : t.getHackathonData().resources.rows,
        ...
        t.selectorCountIs('.b-calendar-cell[data-date="2020-09-27"] > .b-cal-event-bar-container > .b-cal-event-wrap', 2);

        await t.click('.b-calendar-cell[data-date="2020-09-27"] .b-cal-cell-overflow');

        await t.waitForAnimations();

        t.selectorCountIs('.b-calendar-cell[data-date="2020-09-27"] > .b-cal-event-bar-container > .b-cal-event-wrap', 25);
    });
});
