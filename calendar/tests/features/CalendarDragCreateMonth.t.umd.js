...
StartTest(t => {
    ...
    t.it('Should use configured dragUnit', async t => {
        ...
        // We overrode the default for MonthView which is 'day'
        t.is(harness.newEventRecord.durationUnit, 'minute');
        t.is(harness.newEventRecord.duration, 13 * 24 * 60);
    });
});
