StartTest(t => {
    ...
    t.it('Should allow dragging startDate out of view and keep last position', async t => {
        ...
        t.expect(tentativeDates).toEqual([
            ...
            [new Date(2019, 9, 20), new Date(2019, 9, 22), 'Hackathon 2019']
        ]);
    ...
    t.it('Should be able to drag startDate', async t => {
        ...
        t.expect(tentativeDates).toEqual([
            [new Date(2019, 9, 6), new Date(2019, 9, 9), 'Relax and official arrival beer']
        ]);
    ...
    t.it('Should be able to drag startDate back and forward', async t => {
        ...
        t.expect(tentativeDates).toEqual([
            [new Date(2019, 9, 7), new Date(2019, 9, 9), 'Relax and official arrival beer']
        ]);
    ...
    t.it('Should be able to drag startDate up into prior week', async t => {
        ...
        t.expect(tentativeDates).toEqual([
            [new Date(2019, 8, 30), new Date(2019, 9, 6), 'Relax and official arrival beer'],
            [new Date(2019, 9, 6), new Date(2019, 9, 9), 'Relax and official arrival beer']
        ]);
    ...
    t.it('Should constrain drag of startDate to endDate', async t => {
        ...
        t.expect(tentativeDates).toEqual([
            [new Date(2019, 9, 8), new Date(2019, 9, 9), 'Relax and official arrival beer']
        ]);
    ...
    t.it('Should drag endDate', async t => {
        ...
        t.expect(tentativeDates).toEqual([
            [new Date(2019, 9, 8), new Date(2019, 9, 11), 'Relax and official arrival beer']
        ]);
    ...
    t.it('Should drag endDate down into future weeks', async t => {
        ...
        t.expect(tentativeDates).toEqual([
            [new Date(2019, 9, 8), new Date(2019, 9, 13), 'Relax and official arrival beer'],
            [new Date(2019, 9, 13), new Date(2019, 9, 18), 'Relax and official arrival beer']
        ]);
    ...
    t.it('Should scroll the view when dragging close to the edge', async t => {
        await h.init(t, {
            ...
            height : 300,
            events : [
                { id : 1, startDate : '2021-06-02', endDate : '2021-06-03', name : 'Event 1' },
                { id : 2, startDate : '2021-07-08', endDate : '2021-07-09', name : 'Event 2' }
            ]
        });
