...
class DualDayView extends Panel.mixin(CalendarMixin, DaySelectable) {
  ...
  onPaint() {
    var _features$eventToolti, _features$scheduleMen;
    ...
    (_features$eventToolti = features.eventTooltip) === null || _features$eventToolti === void 0 ? void 0 : _features$eventToolti.tooltip.on({
      beforeShow({
        source
      }) {
    ...
    (_features$scheduleMen = features.scheduleMenu) === null || _features$scheduleMen === void 0 ? void 0 : _features$scheduleMen.menu.on({
      beforeShow() {
  ...
  changeMonth(month) {
    ...
    if (!((_month = month) !== null && _month !== void 0 && _month.isMonth)) {
      month = new Month({
        date,
    ...
    if (this.isVisible) {
      const me = this,
        ...
        [start, end] = events.reduce((r, e) => {
          ...
          const startHour = DateHelper.getTimeOfDay(DateHelper.floor(e.startDate, '0.5h'), 'h'),
