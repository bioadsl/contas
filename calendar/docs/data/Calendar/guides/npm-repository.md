...
```shell
$ yarn add @bryntum/calendar@npm:@bryntum/calendar-trial@5.5.2
$ yarn add @bryntum/calendar-angular@5.5.2
```
...
"dependencies": {
  ...
  "@bryntum/calendar-angular": "5.5.2"
}
```
...
```shell
$ yarn add @bryntum/calendar@5.5.2
$ yarn add @bryntum/calendar-angular@5.5.2
```
...
"dependencies": {
  ...
  "@bryntum/calendar": "file:./lib/bryntum-calendar-trial-5.5.2.tgz"
}
```
...
"dependencies": {
  ...
  "@bryntum/calendar": "file:./lib/bryntum-calendar-5.5.2.tgz"
}
```
...
npm ERR! 404
npm ERR! 404 ‘@bryntum/calendar@5.5.2’ is not in the npm registry.
```
