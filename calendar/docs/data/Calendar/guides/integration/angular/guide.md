...
```shell
npm install @bryntum/calendar-angular-view@5.5.2
```
...
```shell
npm install @bryntum/calendar-angular@npm@bryntum/calendar-angular-view@5.5.2
```
...
|------------------|------------------------|----------------------|
| &lt;bryntum-agenda-view/&gt; | BryntumAgendaViewComponent | [AgendaView](#Calendar/widget/AgendaView) |
...
| &lt;bryntum-calendar-row/&gt; | BryntumCalendarRowComponent | [CalendarRow](#Calendar/widget/CalendarRow) |
...
| &lt;bryntum-day-resource-calendar-row/&gt; | BryntumDayResourceCalendarRowComponent | [DayResourceCalendarRow](#Calendar/widget/DayResourceCalendarRow) |
| &lt;bryntum-day-resource-view/&gt; | BryntumDayResourceViewComponent | [DayResourceView](#Calendar/widget/DayResourceView) |
| &lt;bryntum-day-view/&gt; | BryntumDayViewComponent | [DayView](#Calendar/widget/DayView) |
...
| &lt;bryntum-event-list/&gt; | BryntumEventListComponent | [EventList](#Calendar/widget/EventList) |
| &lt;bryntum-event-tip/&gt; | BryntumEventTipComponent | [EventTip](#Calendar/widget/EventTip) |
...
| &lt;bryntum-month-view/&gt; | BryntumMonthViewComponent | [MonthView](#Calendar/widget/MonthView) |
| &lt;bryntum-number-field/&gt; | BryntumNumberFieldComponent | [NumberField](#Core/widget/NumberField) |
| &lt;bryntum-overflow-popup/&gt; | BryntumOverflowPopupComponent | [OverflowPopup](#Calendar/widget/OverflowPopup) |
...
| &lt;bryntum-week-view/&gt; | BryntumWeekViewComponent | [WeekView](#Calendar/widget/WeekView) |
...
| &lt;bryntum-year-view/&gt; | BryntumYearViewComponent | [YearView](#Calendar/widget/YearView) |
