...
```shell
$ yarn add @bryntum/scheduler@npm:@bryntum/scheduler-trial@5.5.2
$ yarn add @bryntum/scheduler-angular@5.5.2
```
...
```json
"dependencies": {
  "@bryntum/scheduler": "npm:@bryntum/scheduler-trial@5.5.2",
...
```shell
$ yarn add @bryntum/scheduler@5.5.2
$ yarn add @bryntum/scheduler-angular@5.5.2
```
...
"dependencies": {
  ...
  "@bryntum/scheduler": "file:./lib/bryntum-scheduler-trial-5.5.2.tgz"
}
```
...
"dependencies": {
  ...
  "@bryntum/scheduler": "file:./lib/bryntum-scheduler-5.5.2.tgz"
}
```
...
npm ERR! 404
npm ERR! 404 ‘@bryntum/scheduler@5.5.2’ is not in the npm registry.
```
