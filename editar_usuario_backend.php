...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($_FILES['foto_perfil']['error'] === UPLOAD_ERR_OK) {
        ...
        $caminhoArquivo = $nomeArquivo; // Altere para o diretório correto
    ...
    $atualizarUsuario = "UPDATE usuarios SET nome = '$nome', email = '$email', senha = '$senha', status = '$status', foto_perfil = '$caminhoArquivo' WHERE id = '$id'";
