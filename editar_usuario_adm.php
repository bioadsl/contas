...
$consulta = "SELECT id, nome, email, privilegio, status, foto_perfil FROM usuarios WHERE id = $usuario_id";
    ...
    <h5 class="card-title">Editar Usuário</h5>
        ...
        <div class="row">
            <div class="col-md-6" style="text-align: center; vertical-align: middle;line-height: 90px;">
                <img src="<?php echo $usuario['foto_perfil'];?>" alt="Foto de Perfil"  width="100%"  class="img-fluid">
            </div>
            <div class="col-md-6">
                <form action="editar_usuario_backend_adm.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="privilegio" name="privilegio" required>
                                    <option value="normal" <?php if ($usuario['privilegio'] === 'normal') echo 'selected'; ?>>Normal</option>
                                    <option value="admin" <?php if ($usuario['privilegio'] === 'admin') echo 'selected'; ?>>Admin</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control-file" id="foto_perfil" name="foto_perfil" accept=".jfif, .jpg, .jpeg, .png">
                    </div>
